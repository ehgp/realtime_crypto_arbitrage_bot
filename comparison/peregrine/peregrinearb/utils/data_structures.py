...
class Collections:
    ...
    def remove_exchange_from_market(self, exchange_name, market_name):
        ...
        if market_name not in self.collections.keys():
            raise ValueError(
                "market {} not in collections. called while trying to remove exchange {}".format(
        ...
        if exchange_name not in self.collections[market_name]:
            raise ValueError(
                "exchange {} not in the exchanges for the provided market {}".format(
